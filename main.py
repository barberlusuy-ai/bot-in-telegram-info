...
async def start_handler(message: types.Message):
    ...
    # ВИПРАВЛЕНО: Створюємо і одразу відправляємо другу кнопку користувачу тут
...
async def save_to_variable(message: types.Message):
    ...
    # Звідси прибрано зламаний шматок з builder2, бо кнопка тепер стабільно видається в команді /start
